...
_EXECUTION_SOURCE_PATHS = (
    ...
    "src/timesoil/aios/blocks.py",
    "src/timesoil/aios/case_profile.py",
    "src/timesoil/aios/cma_search.py",
    "src/timesoil/aios/explain.py",
    "src/timesoil/aios/interwell.py",
    "src/timesoil/aios/planning.py",
    "src/timesoil/aios/policy_space.py",
    "src/timesoil/aios/scenario_generation.py",
    "src/timesoil/aios/schedule.py",
    "src/timesoil/aios/surrogate.py",
    "src/timesoil/aios/track2.py",
    "scripts/compare_track2_cycles.py",
    "scripts/intake_case_z.py",
    "scripts/propose_track2_policies.py",
