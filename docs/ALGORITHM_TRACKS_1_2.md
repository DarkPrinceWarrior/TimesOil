...
| Z: независимые новые BHP-сценарии | [Прогноз 224 месяцев](../deliverables/control_coverage_20260909/timesfm-z-independent-bhp.json) | WAPE нефти 37,96–47,34%; полный автономный допуск не закрыт |
| Y: отдельное обучение месячного прогноза | [Обучение по сценариям](../deliverables/control_coverage_20260909/timesfm-y-monthly-training.json) | Средняя месячная ошибка старых диагностических сценариев улучшена; новая независимая проверка продолжается; рабочие веса автоматически не заменены |
