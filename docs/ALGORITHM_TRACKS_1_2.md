...
**ЧДД ≥15% подтверждён для прежних графиков обоих учебных кейсов; новый Y-цикл ещё проверяется.** Точность нового
...
**Граница схемы.** Исправленная ветвь Y выполняется без TimesFM, её полный
аудит ещё ожидается. В прежнем опыте Y с TimesFM аудит проверил все 23
месячных решения и 364 файла происхождения.
...
|---|---|---|
| Исторический опыт Y с TimesFM/Qwen, 23 месяца; не результат исправленного пути без суррогата | [Архивный месячный аудит](../deliverables/control_coverage_20260909/timesfm-y-complete-monthly-audit.json) | 1 030,940234 → 1 597,087572 млн руб.; **+54,915631%** |
