...
**Срез реализации: 10 сентября 2026, 06:12 UTC.** Трек 1: `5f167bb`;
...
не являются результатом нового цикла без суррогата: он запущен отдельно и
требует завершения всех 23 месяцев и физического аудита.
...
| Проверенный результат полного периода | Новый цикл без суррогата выполняется; прежний опыт с TimesFM: **+54,915631%**, исторический результат | 11 873,620637 → 14 128,268207 млн руб.; **+18,988712%** в TimesFM/Qwen-цикле; сохранён лучший физический график **+19,123503%** |
