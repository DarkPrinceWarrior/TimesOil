...
**Срез реализации: 10 сентября 2026, 04:23 UTC.** Трек 1: `17be7d5`;
Трек 2 и обучение Google TimesFM: `446b968`.
...
| Y: отдельное обучение месячного прогноза | [Независимые новые режимы](../deliverables/forecast_validation_20260910/y-monthly-independent-v2.json) | Средняя нефть 2,89–5,27%; первый месяц нового режима 22,48–45,58%; рабочие веса автоматически не заменены |
