...
## 6. Docker на A100 через существующий SSH-прокси

После запуска обратного туннеля из раздела 5 указать в серверном
`config/aios.env` значение `LLM_PROXY_URL=http://127.0.0.1:18889`.
