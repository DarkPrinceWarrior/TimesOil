...
|-----------|------------|--------|
| **tNavigator** | Промышленный симулятор; Model Y — нативный формат исходников | **Коммерческая лицензия** (RFD / Rock Flow Dynamics) |
...
Актуальный архив трека 2 — **Model_Z_final_OPM.zip**; считать на **OPM Flow** (или tNavigator при лицензии).
